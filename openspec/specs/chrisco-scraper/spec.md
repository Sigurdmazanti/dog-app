...
Defines the requirements for scraping product data from `chrisco.dk`, including page extraction logic, source registry routing, JSON source scaffold, and selector reference documentation.
