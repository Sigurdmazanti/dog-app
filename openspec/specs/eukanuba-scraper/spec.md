...
Define the Eukanuba scraper: page extraction selectors, source registry routing, and the source JSON structure including discovery config and product URL lists.
