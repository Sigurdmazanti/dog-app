...
Define the scraper's typed composition data model, alias-based key mapping, fallback-safe output, and Google Sheets export contract for dog food product nutritional data.
