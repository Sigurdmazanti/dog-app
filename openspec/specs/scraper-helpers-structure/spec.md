...
Defines the canonical directory layout for `scraper/src/helpers/` so that helper files are grouped by domain concern rather than kept in a flat folder, making the codebase easier to navigate and maintain.
