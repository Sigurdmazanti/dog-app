...
Define how each registered scraper source declares its brand name, how that brand propagates through the scrape pipeline to `ScrapeDataRow`, and how it is exported to Google Sheets as the `item_brand` column.
