...
Define Swedish-language alias mappings in the composition key maps so that Swedish pet food labels are resolved to the correct canonical nutrition fields.
