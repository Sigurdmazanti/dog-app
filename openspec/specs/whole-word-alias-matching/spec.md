...
The function SHALL be case-insensitive and MUST handle multi-word aliases (for example, `"crude fat"`) correctly by checking boundaries only at the outer edges of the alias string.
